...
BEGIN
{
  ...
  $postmaster        = '';
  @referers          = qw(grancitm-gamejam.github.io/webpage/contact.html grancitm-gamejam.github.io/webpage/contact.html);
  @allow_mail_to     = qw(grancitm.gamejam@gmail.com);
  @recipients        = ();
  %recipient_alias   = ();
